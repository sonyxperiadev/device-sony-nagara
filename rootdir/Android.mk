...
LOCAL_SRC_FILES := vendor/etc/fstab.nagara
...
include $(CLEAR_VARS)
LOCAL_MODULE := init.nagara
LOCAL_SRC_FILES := vendor/etc/init/init.nagara.rc
LOCAL_MODULE_TAGS := optional
...
include $(CLEAR_VARS)
LOCAL_MODULE := init.nagara.pwr
LOCAL_SRC_FILES := vendor/etc/init/init.nagara.pwr.rc
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .rc
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_ETC)/init
